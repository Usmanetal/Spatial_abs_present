...
library(readxl)
hiv_data<- read_excel("C:/Users/Usman Ola/Documents/Spatial_abs_present/data for geospatial distribution of HCV.xlsx")
...
data <- nigeria_states %>%
  left_join(hiv_data, by = c("name"))
# Plot Nigeria state boundaries

# Replace with the path to your extracted shapefile
nigeria_lga_shapefile <- "C:/Users/Usman Ola/Documents/Spatial_abs_present/NGA_adm2.shp"
